                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="/productos" enctype="mutipart/form-data">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="exampleFormControlInput1" name="precio" type="text">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleFormControlInput1">Cantidad</label>
                                            <input class="form-control" id="exampleFormControlInput1" name="cantidad" type="text">
                                        </div>
