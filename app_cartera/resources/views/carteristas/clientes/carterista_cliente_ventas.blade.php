...
@section('content')
    ...
    @include('Partials.general.alertas')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="row center-md card-body">
                                    ...
                                    <a class="btn btn-primary col-md-2" type="button" href="{{ route('carterista.gestion_cliente_cartera', $cliente_id) }}">Volver</a>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                <div class="card-header">Listado de transacciones del cliente</div>
                <div class="card-body">
                    <div class="datatable">
